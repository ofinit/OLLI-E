...
// Mock Data for Users
const mockUsers = [
  { id: "usr_9k21ms", email: "sarah.j@acme.inc", joined: "Oct 12, 2025", balance: 145.50, role: "User", status: "Active" },
  { id: "usr_4b77pq", email: "dev@tech-forge.co", joined: "Nov 03, 2025", balance: 890.00, role: "Enterprise", status: "Active" },
  { id: "usr_1x99lz", email: "mike.chen@solo.io", joined: "Dec 18, 2025", balance: 12.25, role: "User", status: "Active" },
  { id: "usr_7t44nm", email: "spam.bot@free.ru", joined: "Jan 14, 2026", balance: 0.00, role: "User", status: "Suspended" },
  { id: "usr_op22qa", email: "admin@olli-e.ai", joined: "Aug 01, 2025", balance: 9999.00, role: "Admin", status: "Active" },
  { id: "usr_3v88cw", email: "design@agency.co", joined: "Feb 22, 2026", balance: 45.00, role: "User", status: "Active" },
];
                ...
                {mockUsers.map((user, i) => (
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="h-8 w-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 font-bold border border-blue-100/50 shrink-0">
